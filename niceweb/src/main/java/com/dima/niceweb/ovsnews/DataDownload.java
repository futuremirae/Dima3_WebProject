...
public class DataDownload {
    ...
    public static String getOvsNews() throws IOException{
        StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/B410001/kotra_overseasMarketNews/ovseaMrktNews/ovseaMrktNews");
        ...
        urlBuilder.append("&" + URLEncoder.encode("search6", "UTF-8") + "=" + URLEncoder.encode("ECNMY,ANA", "UTF-8"));
        urlBuilder.append("&" + URLEncoder.encode("search7", "UTF-8") + "=" + URLEncoder.encode("20230721", "UTF-8"));
