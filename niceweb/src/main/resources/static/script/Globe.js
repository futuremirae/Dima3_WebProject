...
am5.ready(function () {
    ...
    const continentCountries = {
        "Asia": ["CN", "KR", "IN", "MY", "JP", "TH", "HK", "SG", "TW", "AE", "IL", "BH", "QA", "VN", "SA", "ID", "PH", "PK", "LK", "UZ", "RU"],
    ...
    // 국가명, 78개국
    const countryNames = {
        "CN": "China", "KR": "South Korea", "IN": "India", "MY": "Malaysia", "JP": "Japan", "TH": "Thailand", "HK": "Hong Kong", "SG": "Singapore", "TW": "Taiwan", "AE": "United Arab Emirates",
        "IL": "Israel", "BH": "Bahrain", "QA": "Qatar", "VN": "Vietnam", "SA": "Saudi Arabia", "ID": "Indonesia", "PH": "Philippines", "PK": "Pakistan", "LK": "Sri Lanka", "UZ": "Uzbekistan",
        "DE": "Germany", "GB": "United Kingdom", "FR": "France", "SE": "Sweden", "AT": "Austria", "DK": "Denmark", "IT": "Italy", "BE": "Belgium", "NL": "Netherlands", "SI": "Slovenia",
        "HU": "Hungary", "CH": "Switzerland", "CZ": "Czech Republic", "RO": "Romania", "TR": "Turkey", "RS": "Serbia", "PL": "Poland", "UA": "Ukraine", "SK": "Slovakia", "FI": "Finland",
        "BG": "Bulgaria", "EE": "Estonia", "GR": "Greece", "NO": "Norway", "PT": "Portugal", "LV": "Latvia", "HR": "Croatia", "GE": "Georgia", "BY": "Belarus", "LT": "Lithuania",
        "MT": "Malta", "BA": "Bosnia and Herzegovina", "ES": "Spain", "US": "United States", "CA": "Canada", "MX": "Mexico", "GT": "Guatemala", "CR": "Costa Rica", "SV": "El Salvador", "JM": "Jamaica",
        "NI": "Nicaragua", "DO": "Dominican Republic", "VG": "British Virgin Islands", "PA": "Panama", "BR": "Brazil", "CO": "Colombia", "AR": "Argentina", "CL": "Chile", "VE": "Venezuela", "EC": "Ecuador",
        "TT": "Trinidad and Tobago", "ZA": "South Africa", "NG": "Nigeria", "EG": "Egypt", "MA": "Morocco", "KE": "Kenya", "NZ": "New Zealand", "AU": "Australia", "RU": "Russia"
    };
